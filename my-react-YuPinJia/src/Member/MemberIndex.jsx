    ...
    <>
      <div className="navbar d-flex  justify-content-between text-center w-100 px-4">
        <div className="d-flex">
          <NavbarItem text="建立會員" active={activeTab === "建立會員"} onClick={() => setActiveTab("建立會員")}/>
          <NavbarItem text="會員總覽" active={activeTab === "會員總覽"} onClick={() => setActiveTab("會員總覽")} />
          <NavbarItem text="賒帳紀錄" active={activeTab === "賒帳紀錄"} onClick={() => setActiveTab("賒帳紀錄")} />
          <NavbarItem text="黑名單" active={activeTab === "黑名單"} onClick={() => setActiveTab("黑名單")}/>
        </div>
      </div>
      {/* 內容區域 */}
